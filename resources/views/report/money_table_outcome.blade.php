...
<ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link" href="/report/income/table">Pendapatan</a>
    </li>
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Pengeluaran</a>
    </li>
</ul>
<div class="row">
    <div class="col-12">
          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0 d-flex justify-content-end">
              <div class="mb-3 ml-auto p-2 m-2">
                  <a href="{{ route('dashboard.report.outcome.index') }}" class="btn btn-primary" id="btn-excel">
