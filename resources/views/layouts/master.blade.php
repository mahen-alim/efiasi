  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
        <img src="{{ asset ('img/eviasi-logo.png') }}"  class="d-flex mx-auto " style="width: 150px height: 150px;" alt="main_logo">
    </div>
    ...
    <div class="  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->is('operational') ? 'active' : '' }}" href="{{ route('dashboard.operational.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Operasional</span>
          </a>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Notifikasi</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->is('notif') ? 'active' : '' }}" href="/notif">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->is('profil') ? 'active' : '' }}" href="/profile">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item text-sm">
              @switch(true)
                  ...
                  @case(Request::is('dashboard/sparepart/create') || Request::is('dashboard/sparepart/*/edit'))
                      ...
                      @break
                  @case(Request::is('dashboard/operational/create') || Request::is('dashboard/operational/*/edit'))
                      <a class="opacity-5 text-dark" href="{{ route('dashboard.operational.index') }}">Operasional</a>
                      @break
                  @case(Request::is('report/income/table'))
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">
            <a class="opacity-5 text-dark">
              ...
              @elseif(Request::is('dashboard/sparepart/*/edit'))
                  Edit Sparepart
              @elseif(Request::is('dashboard/sparepart'))
                  Sparepart
              @elseif(Request::is('dashboard/operational/create'))
                  Tambah Operasional
              @elseif(Request::is('dashboard/operational/*/edit'))
                  Edit Operasional
              @elseif(Request::is('dashboard/operational'))
                  Operasional
          ...
          <h6 class="font-weight-bolder mb-0">
            @if(Request::is('service/create') || Request::is('sparepart/create') || Request::is('operational/create'))
            <h6 class="opacity-5 text-dark">Formulir Penambahan Data</h6>
            @elseif(Request::is('service/*/edit') || Request::is('sparepart/*/edit') || Request::is('operational/*/edit'))
            <h6 class="opacity-5 text-dark">Formulir Pengeditan Data</h6>
            @elseif(Request::is('report/money/table'))
            <h6 class="opacity-5 text-dark">Tabel Rekap Keuangan</h6>
            @endif    
          </h6>
        </nav>
